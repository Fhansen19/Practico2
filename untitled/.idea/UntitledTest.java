...
public class UntitledTest {
  ...
  public void untitled() {
    ...
    driver.manage().window().setSize(new Dimension(1420, 840));
    ...
    driver.findElement(By.id("email")).sendKeys("testuno@gmail.com");
    driver.findElement(By.id("id_order")).click();
    driver.findElement(By.id("id_order")).sendKeys("test uno");
